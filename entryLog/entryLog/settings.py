"""
Django settings for entryLog project.
...
SECRET_KEY = '##$*8v6xs=0qehw7&29^$*l2r=_kbzjg1^l8)o3mca*8-d##je'
...
WSGI_APPLICATION = 'entryLog.wsgi.application'
